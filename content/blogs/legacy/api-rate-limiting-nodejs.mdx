...
In production, your API is always under attack either by malicious bots or by buggy client-side code that enters an infinite loop. Without rate limiting, a single runaway process can consume your database connections and crash your entire infrastructure.
