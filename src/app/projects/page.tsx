    ...
    return (
        <PageTransition>
            <div className="pt-24 pb-32 space-y-24">
                {/* High-Impact Hero */}
                <Section id="projects-hero" title="" className="!py-16 md:!py-28 relative overflow-hidden">
                    <GridPattern />
                            ...
                            <div className="max-w-3xl space-y-10">
                                <div className="space-y-2">
                                    ...
                                    <h1 className="text-6xl md:text-9xl lg:text-[10rem] font-black uppercase tracking-tighter italic leading-[0.75] select-none">
                                        The <br />
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-blue-400 to-primary animate-gradient-x italic">Solutions.</span>
                                    </h1>
                                </div>

                                <p className="text-xl md:text-3xl text-foreground/50 leading-tight font-medium max-w-xl italic">
                                    Engineering systems that transform <span className="text-white">bottlenecks</span> into automated competitive advantages.
                                </p>
                            </div>
                ...
                {/* Bottom CTA Section */}
                <Section id="projects-cta" title="" className="relative overflow-hidden">
                    <div className="w-full py-20 rounded-[4rem] bg-white/[0.01] border border-white/5 text-center relative overflow-hidden">
                        ...
                        <p className="relative z-10 text-foreground/50 mb-12 max-w-xl mx-auto leading-relaxed italic font-medium">
                            I specialize in taking messy, manual workflows and turning them into streamlined, high-performance digital ecosystems.
                        </p>
                        <a
                            href="/contact"
                            className="relative z-10 inline-flex items-center gap-4 px-12 py-6 bg-primary text-white font-black uppercase tracking-[0.2em] rounded-full hover:scale-105 transition-transform shadow-[0_0_50px_-10px_rgba(var(--primary-rgb),0.5)] active:scale-95"
                        >
                            Start a Project
                        </a>
                    </div>
