...
export default function ContactPage() {
    return (
        <div className="pt-24 pb-32 space-y-24">
            ...
            <Section id="contact-hero" title="">
                <div className="max-w-7xl mx-auto px-4 relative">
                    <div className="absolute top-0 left-0 w-[40rem] h-[40rem] bg-primary/10 blur-[200px] rounded-full pointer-events-none -translate-x-1/2 -translate-y-1/2" />
            ...
            {/* Availability Detail */}
            <Section id="availability" title="">
                <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-foreground/20">Response SLA</p>
                    <p className="text-lg md:text-xl text-foreground/40 font-bold uppercase tracking-widest max-w-lg mx-auto leading-relaxed">
