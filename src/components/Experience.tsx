...
const experience = [
    {
        ...
        description: "Engineered a scalable full-stack architecture that drove a 30% boost in business engagement. Built automated multi-channel product integrations connecting Alibaba and Amazon APIs, completely eliminating manual synchronization tasks.",
    ...
    },
    {
        ...
        description: "Deployed 10+ production front-ends and integrated 15+ microservices, accelerating feature delivery cycles. Decreased application load times by 50% via advanced UI architectures. Eliminated structural deployment failures by establishing robust CI/CD pipelines.",
    ...
    },
    {
        ...
        description: "Revamped 20+ legacy interfaces into high-performance components, directly contributing to a 25% lift in user engagement. Improved search rankings and shaved off 40% of load latency through strict technical optimization.",
    ...
    },
    {
        ...
        description: "Reinforced core product stability by actively monitoring and upgrading production interfaces. Minimised operational downtime via rigorous regression testing and preemptive bug resolution.",
